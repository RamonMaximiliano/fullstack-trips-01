...
export default function TripReservation(props: TripItemsProps & { startDate: string, endDate: string }): React.JSX.Element {
    ...
    return (
        <div className="leading-7 mx-auto w-11/12 my-2">
            ...
            <input placeholder={`Numero de hospedes (max:${trip.maxGuests || 'N/A'})`} className="p-2 rounded-lg w-full border-2 border-gray-300 mt-1" type="number" min="1" max="5"></input>
