    ...
    return (
        <>
            <div className="bg-gray-400">
                <div className="container mx-auto p-5 items-center justify-between flex flex-col lg:w-3/4 lg:px-8">
                    <h1 className="font-bold text-lg py-2">Encontre sua próxima <span className="text-primary">viagem!</span></h1>
